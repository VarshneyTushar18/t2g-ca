        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center gap-10">
          <div className="w-full md:w-1/2">
            <div>
              ...
              <img
                src="/images/services/why-influencer.webp"
      ...
      <section className="py-16 bg-white overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mt-12">
            ...
            <div className="flex flex-col">
              <Image width={100} height={100} src="/images/services/Affiliate-icon.webp" alt="Affiliate" className="mb-3" />
              <h3 className="text-xl font-bold text-[#c7010c] mb-4">
            ...
            <div className="flex flex-col">
              <Image width={100} height={100} src="/images/services/Celebrity-icon.webp" alt="Celebrity" className="mb-3" />
              <h3 className="text-xl font-bold text-[#c7010c] mb-4">
            ...
            <div className="flex flex-col">
              <Image width={100} height={100} src="/images/services/creator-icon.webp" alt="Creator" className="mb-3" />
              <h3 className="text-xl font-bold text-[#c7010c] mb-4">
                Creator Onboarding
              </h3>
              <p className="text-[#555555] leading-relaxed text-[15px] md:text-[16px] font-normal flex-grow">
